module "eks_addons" {
  ...
  # Cluster information
  cluster_name      = module.retail_app_eks_cluster.cluster_name
  cluster_endpoint  = module.retail_app_eks_cluster.cluster_endpoint
  cluster_version   = module.retail_app_eks_cluster.cluster_version
  oidc_provider_arn = module.retail_app_eks_cluster.oidc_provider_arn
  ...
  depends_on = [module.retail_app_eks_cluster]
}
