...
output "cluster_name" {
  ...
  value       = module.retail_app_eks_cluster.cluster_name
}
...
output "cluster_endpoint" {
  ...
  value       = module.retail_app_eks_cluster.cluster_endpoint
}

output "cluster_version" {
  description = "The Kubernetes version for the EKS cluster"
  value       = module.retail_app_eks_cluster.cluster_version
}

output "cluster_security_group_id" {
  description = "Security group ID attached to the EKS cluster"
  value       = module.retail_app_eks_cluster.cluster_security_group_id
}

output "cluster_oidc_issuer_url" {
  description = "The URL on the EKS cluster for the OpenID Connect identity provider"
  value       = module.retail_app_eks_cluster.cluster_oidc_issuer_url
}
...
output "configure_kubectl" {
  ...
  value       = "aws eks update-kubeconfig --region ${var.aws_region} --name ${module.retail_app_eks_cluster.cluster_name}"
}
